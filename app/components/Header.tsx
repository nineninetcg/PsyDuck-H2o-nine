...
export function Header({
  ...
  return (
    <header id="main-header" className="fixed top-0 left-0 right-0 z-50 bg-white text-black w-full">
      {/* Utility bar */}
      <div className="hidden md:flex items-center justify-between px-8 py-2 bg-[#111111] text-white text-xs">
        <div className="flex items-center gap-5">
          <a href="https://wa.me/60179339076" className="font-semibold text-white/85 hover:text-[#9ad2e6] flex items-center gap-1.5">
          ...
          <LocaleNavLink to="/pages/contact" className="font-semibold text-white/85 hover:text-[#9ad2e6]">Customer Service</LocaleNavLink>
        </div>
        <TrustpilotBadge />
        <span className="font-bold text-white/70">MYR ▾</span>
      </div>
